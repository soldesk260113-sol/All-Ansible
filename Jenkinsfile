pipeline {
    ...
    parameters {
        choice(name: 'PLAYBOOK', choices: ['site.yml', 'playbooks/00_network_provisioning.yml', 'playbooks/01_common_setup.yml', 'playbooks/02_k8s_install.yml', 'playbooks/03_deploy_monitoring.yml', 'playbooks/04_deploy_db.yml', 'playbooks/05_deploy_cicd.yml', 'playbooks/06_deploy_registry.yml', 'playbooks/07_deploy_argocd.yml', 'playbooks/08_deploy_security.yml'], description: 'Select the playbook to run')
